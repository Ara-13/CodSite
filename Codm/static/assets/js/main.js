...
document.addEventListener("DOMContentLoaded", ChangeThemeByHour)
...
function ChangeThemeByHour(){
  ...
  let hour = d.getHours();
  if (hour < 19 && hour > 6){
      css.href = '/static/assets/css/main.css';
 ...
 //document.getElementsByTagName('BODY').onload = ChangeThemeByHour();