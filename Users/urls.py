...
urlpatterns = [
    ...
    re_path(r'^cart/success/finished/order/(?P<order>[0-9]{1,10})/(?P<order1>[0-9]{1,10})$', views.cart_finished, name="cart-finished"),
    ...
    re_path(r'^MyAccount/Orders/OrderAccountDetail/(?P<co>[0-9]{1,10})/$', views.UserOrderAccountDetail, name="UserOrderAccountDetail"),
    ...
    re_path(r'^SiteTheme/(?P<mode>[a-z]{1,10})/$', views.site_mode, name="ChangeMode"),
]